// src/pages/admin/components/ConfirmationModal.jsx (Dành cho Post)
...
// Đổi tên prop từ isMutating thành isLoading để nhất quán với file User
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex justify-center items-center z-50 p-4 animate-fade-in">
      <div className="relative bg-white rounded-2xl shadow-xl p-8 w-full max-w-md mx-auto transform transition-all animate-scale-in">
        <button
          onClick={onClose}
          disabled={isLoading} // Sử dụng isLoading
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          >
            {/* === LOGIC HIỂN THỊ SPINNER GIỐNG NHƯ MODAL BÊN USER === */}
            {isLoading ? (
              <>
